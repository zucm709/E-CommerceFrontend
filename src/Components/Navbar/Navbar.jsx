import React, { useContext,useState } from 'react'; // Added missing useState import
import './Navbar.css';
    ...
    return (
        <div className='navbar'>
            ...
            <ul className='nav-menu'>
                <li onClick={() => { setMenu("shop")}}><Link style={{ textDecoration: 'none',color:' #626262' }} to='/shop'>Shop</Link>{menu==="shop"?<hr/>:<></>}</li>
